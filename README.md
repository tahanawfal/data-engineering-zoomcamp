...
### 01-docker-terraform
- [homework choices](/01-docker-terraform/1st_week_homework.md)
- homework code
  - [ingestion python script](/01-docker-terraform/ingest_data.py)
  - [docker compose file](/01-docker-terraform/docker-compose.yaml)
...
- public learning posts
  - [Linkedin-Post-01](https://www.linkedin.com/posts/tahanawfal_dockerizingdatapipelines-ugcPost-7421890957907742720--vs7)

### 02-workflow-orchestration
- [homework choices](/02-workflow-orchestration/2nd_week_homework.md)
- homework code
  - [Kestra scripts](/02-workflow-orchestration/flows/)
  - [docker compose file](/02-workflow-orchestration/docker-compose.yaml)
- public learning posts
  - [Repo-Contribute-01](https://github.com/DataTalksClub/faq/issues/124)

### 03-data-warehouse
- [homework choices](/03-data-warehouse/3rd_week_homework.md)
...
- [homework choices](/04-analytics-engineering/4th_week_homework.md)
